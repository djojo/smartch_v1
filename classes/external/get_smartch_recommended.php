 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
trait get_smartch_recommended
{
    /**
     * Describes the parameters for get_smartch_recommended
     * @return external_function_parameters
     */
    public static function get_smartch_recommended_parameters()
    {
     ...
     * @return boolean       true
     */
    public static function get_smartch_recommended()
    {
        global $PAGE, $USER;
    ...
    /**
     * Describes the get_smartch_recommended return value
     * @return external_value
     */
    public static function get_smartch_recommended_returns()
    {
