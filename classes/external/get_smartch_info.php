 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
trait get_smartch_info
{
    /**
     * Describes the parameters for get_smartch_info
     * @return external_function_parameters
     */
    public static function get_smartch_info_parameters()
    {
     ...
     * @return boolean       true
     */
    public static function get_smartch_info()
    {
        global $DB, $USER;
        ...
        //on va chercher l'image fixe
        $imagefixelist = $DB->get_records_sql('SELECT * 
     ...
     */
    public static function get_smartch_info_returns()
    {
