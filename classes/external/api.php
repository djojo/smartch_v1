...
class api extends external_api
{
    ...
    use get_smartch_info;
    use get_smartch_role;
    use get_smartch_course_info;
    use get_smartch_pub;
    use get_smartch_my_courses;
    use get_smartch_my_formations;
    use get_smartch_recommended;
    use get_smartch_stats;
    use get_smartch_module_activities;
    use get_smartch_my_teams_course;
    use get_smartch_calendar;
}
